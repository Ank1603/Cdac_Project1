  ...
  const reviews = [
    {
      ...
      name: "Yash Gite",
      platform: "Google",
      workshop: "Urja Automobiles - Panchwati, Sri Ram nagar, Konark Nagar, Nashik",
        ...
        <div className="hero-section">
          ...
          <div className="hero-text">
            ...
            <p>
              ...
              by Urja Automobiles, to be your world-class workshop next door for complete car
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-8">
              ...
              <p>
                At Urja Automobiles, we believe in delivering top-notch automotive
                solutions tailored to your needs. With cutting-edge technology and
                a team of certified experts, we are redefining car care and service
                excellence. Our mission is to ensure your vehicle runs at its best,
                offering you a seamless and reliable experience. Trust Urja Automobiles
                to keep your car in pristine condition, maximizing its performance and
                lifespan.
              </p>
              <div className="container">
                <div className="row">
                  <div className="col-xl-4 m-3">
                    <img src="https://www.garage.movemycar.in/assets/images/garage.png" alt="" />
                  ...
                  <div className="col-xl-4 m-3">
                    ...
                    <br />
                    <span>
                      Equipped with advanced tools and infrastructure
                    </span>
                  </div>
                  <div className="col-xl-4 m-3">
                    <img
                    ...
                    <br />
                    <span>
                      Quality car care at prices that fit your budget
                    </span>
                  </div>
                  <div className="col-xl-4 m-3">
                    <img
        ...
        <div class="container my-5 py-4 text-start">
          <div class="row align-items-center">
            ...
            <div class="col-md-8">
              ...
              <button onclick="f1()" class="btn btn-danger btn-lg">
                Book an Appointment
              </button>
            </div>
          </div>
